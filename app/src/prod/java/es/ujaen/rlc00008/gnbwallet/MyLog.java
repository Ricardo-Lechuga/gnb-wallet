...
public abstract class MyLog {
	...
	public static boolean FLAG_WARN = false;
	public static boolean FLAG_INFO = false;
	public static boolean FLAG_VERBOSE = false;
	public static boolean FLAG_ERROR = false;
	public static boolean FLAG_WTF = false;
	public static boolean FLAG_STACKTRACE = false;
